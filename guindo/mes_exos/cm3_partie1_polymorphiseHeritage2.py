...
class Order:
    ...
    def process_payment(self, payment_method: PaymentMethod):
        ...
        POLYMORPHISME : Cette méthode ne sait pas si elle traite une carte, 
        un virement ou du Bitcoin. Elle utilise l'interface générique PaymentMethod.
        """
        ...
        # Le polymorphisme en action : appel dynamique selon l'instance reçue
