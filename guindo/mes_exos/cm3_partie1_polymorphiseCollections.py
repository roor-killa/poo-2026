...
class Shape(ABC):
    ...
    @abstractmethod
    def area(self) -> float:
        """Calcule l'aire de la forme (doit être redéfinie)"""
        pass
    
    @abstractmethod
    def perimeter(self) -> float:
        """Calcule le périmètre de la forme (doit être redéfinie)"""
        pass
    
    @abstractmethod
    def get_name(self) -> str:
        """Retourne le nom descriptif de la forme (doit être redéfinie)"""
        pass
...
def calculate_total_area(shapes: List[Shape]) -> float:
    """
    Calcule l'aire totale d'une collection de formes.
    POLYMORPHISME : On appelle .area() sans savoir si c'est un Rectangle ou un Cercle.
    """
